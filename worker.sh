...
ls
# ./Summer20UL18_SampleMaker.sh -test ${model}_fragment.py
echo "..........starting step1 cmsDriver.py......"
./Summer20UL18_SampleMaker.sh -testGEN ${model}_fragment.py
ls

./Summer20UL18_SampleMaker.sh -prod ${model}_fragment.py $nEvents PrivSample_${model}_Summer20UL18.root $jobID
