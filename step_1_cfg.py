...
# with command line options: Configuration/GenProduction/python/SUS-RunIISummer20UL18wmLHEGEN-DarkHiggs-fragment.py --python_filename SUS-RunIISummer20UL18wmLHEGEN-DarkHiggs-fragment_step_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:OutRoot_1.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.source.numberEventsInLuminosityBlock = cms.untracked.uint32(10000) --step LHE,GEN --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 5000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SUS-RunIISummer20UL18wmLHEGEN-DarkHiggs-fragment.py nevts:5000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:OutRoot_1.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:OutRoot_1_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/home/vhegde/Physics/darkHiggsSampleGen/PrivateSamples/DarkHiggs_WW_Zp2000_s200_Chi100_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
