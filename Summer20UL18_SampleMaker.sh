...
# Examples
# ./Summer20UL18_SampleMaker.sh -test SUS-RunIISummer20UL18wmLHEGEN-DarkHiggs-fragment.py
# ./Summer20UL18_SampleMaker.sh -prod SUS-RunIISummer20UL18wmLHEGEN-DarkHiggs-fragment.py 10 MyOut.root 1
...
CMSSWList=("CMSSW_10_6_30_patch1" "CMSSW_10_6_17_patch1" "CMSSW_10_6_17_patch1" "CMSSW_10_2_16_UL" "CMSSW_10_6_17_patch1" "CMSSW_10_6_20" "CMSSW_10_6_32_patch1")
...
if [ "$1" = "-test" ] || [ "$1" = "-testGEN" ] ; then
 ...
 --fileout file:OutRoot_${StepCount}.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended\
 --filein file:OutRoot_$((StepCount-1)).root --era Run2_2018 --runUnscheduled --no_exec --mc -n -1 || exit $? ;

    # Step 7
    GetCMSSW CMSSW_10_6_32_patch1

    cmsDriver.py  --python_filename step_${StepCount}_cfg.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:OutRoot_${StepCount}.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step NANO --filein file:OutRoot_$(( StepCount-1 )).root --era Run2_2018,run2_nanoAOD_106Xv2 --no_exec --mc -n -1 || exit $? ;
    ...
    xrdcp -f MiniAODv2_job${jobID}_${FinalRootFile} root://cmseos.fnal.gov//store/user/vhegde/Physics/DarkHiggsPrivSamples/MiniAODv2_Summer20UL/
    xrdcp -f NanoAODv9_job${jobID}_${FinalRootFile} root://cmseos.fnal.gov//store/user/vhegde/Physics/DarkHiggsPrivSamples/NanoV9/
    rm OutRoot*.root
